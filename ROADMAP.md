...
- standard comune;
- catalogo iniziale;
- prime cinque procedure del nucleo.

## Versione 0.2 — Consolidamento

- procedure su test, sicurezza, prestazioni e documentazione;
- glossario ampliato;
- modelli di rapporto;
...
- [x] metadati e versionamento delle procedure;
- [x] validatore automatico di `PROCEDURA.md`;
...
- [ ] verifica operativa di ARI-0005 — ARI-0010;
